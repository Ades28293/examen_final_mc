...
public class CompraPasaje {
	...
	private String cantidadAsientosComprados;
	...
	public String getCantidadAsientosComprados() {
		return cantidadAsientosComprados;
	}

	public void setCantidadAsientosComprados(String cantidadAsientosComprados) {
